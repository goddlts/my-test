...
import { Upload, CheckboxGroup, Checkbox, Cascader, Tabs, TabPane, Steps, Step, Alert, MenuItem, Dialog, Card, Tag, Message, Notification, Tree, Select, Option, Pagination, Switch, Loading, Input, Table, TableColumn, Breadcrumb, BreadcrumbItem, Button, Form, FormItem, Container, Header, Row, Col, Aside, Menu, Submenu, Main, MessageBox } from 'element-ui'
...
Vue.use(Loading.directive).use(Alert).use(Steps).use(Step).use(Upload)
Vue.use(Tabs).use(TabPane).use(Cascader).use(CheckboxGroup).use(Checkbox)
